...
declare type ArgumentTypes<F extends VariableArgFunction> = F extends (...args: infer A) => any ? A : never;
declare namespace BetterSqlite3 {
    ...
    interface Database {
        ...
        prepare<BindParameters extends any[] | {} = any[]>(source: string): BindParameters extends any[] ? Statement<BindParameters> : Statement<[BindParameters]>;
...
declare namespace Database {
    ...
    type Statement<BindParameters extends any[] | {} = any[]> = BindParameters extends any[] ? BetterSqlite3.Statement<BindParameters> : BetterSqlite3.Statement<[BindParameters]>;
...
export declare const Database: BetterSqlite3.DatabaseConstructor;
export {};
